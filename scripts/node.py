...
class ParticleFilterLocalisationNode(object):
    def __init__(self):
        ...
        self._amcl_pose_publisher = rospy.Publisher("/amcl_pose", PoseWithCovarianceStamped, queue_size=10)
        self._cloud_publisher = rospy.Publisher("/particlecloud", PoseArray, queue_size=50)
